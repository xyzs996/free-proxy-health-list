...
- **[LLM API pricing list](https://github.com/xyzs996/llm-api-pricing)** — bir satırdaki liste fiyatı, bir isteğin fiyatı değildir. Başka fiyat tablolarının attığı sütun burada duruyor: istem uzayınca devreye giren ikinci, daha pahalı tarife — üstelik o tarife, eşiği aşan tokenlara değil isteğin tüm tokenlarına işler. Yazılardaki her sayı da [tek bir tabloda](https://xyzs996.github.io/llm-api-pricing/figures.html), her satır alındığı cümleyle birlikte ([JSON](https://cdn.jsdelivr.net/gh/xyzs996/llm-api-pricing@main/data/figures.json) / [CSV](https://cdn.jsdelivr.net/gh/xyzs996/llm-api-pricing@main/data/figures.csv)). [Token faturası gerçekte nereye gidiyor](https://xyzs996.github.io/llm-api-pricing/topics/token-optimization.html) ile başlayın.
